 ...
 * the schema.
 */
typedef struct ArrowFFIData ArrowFFIData;
#endif
 ...
 *
 */
typedef struct EngineData *HandleEngineData;
 ...
 */
void drop_bool_slice(struct KernelBoolSlice slice);
 ...
 * Caller is responsible for passing a valid handle.
 */
void drop_engine(HandleSharedExternEngine engine);
 ...
 * Caller is responsible for passing a valid handle.
 */
void drop_snapshot(HandleSharedSnapshot snapshot);
 ...
 */
void *get_raw_engine_data(HandleEngineData data);
 ...
 */
struct ExternResultArrowFFIData get_raw_arrow_data(HandleEngineData data,
                                                   HandleSharedExternEngine engine);
#endif
 ...
 */
void drop_scan(HandleSharedScan scan);
 ...
 */
void drop_global_scan_state(HandleSharedGlobalScanState state);
 ...
 */
void kernel_scan_data_free(HandleSharedScanDataIterator data);
 ...
 */
void visit_scan_data(HandleEngineData data,
